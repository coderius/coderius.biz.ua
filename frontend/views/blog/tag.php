...
$this->params['breadcrumbs'][] = Html::encode("Посты с меткой ⟪" . $tag->title . "⟫");


?>
<h1 class="col-xs-12 h_style_1">Посты с меткой ⟪<a href="<?= Url::toRoute(['/blog/tag', 'alias' => $tag->alias]); ?>"><?= $tag->title; ?></a>⟫</h1>
